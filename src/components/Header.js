function Header(props) {
    ...
    <img className="align-cente" width={40} height={40} src="cerebrum clubpr.png"></img>
    <div className="headerRight align-cente">
      ...
      <ul className="d-flex">
        ...
        <img width={20} height={20} src="/img/kart.svg"></img>
        <div className="Hert">
        
      <img width={20} height={20} src="/img/Hert.svg"></img>
      </div>
        <span>1205 руб.</span> 
        </li>
        <li>
